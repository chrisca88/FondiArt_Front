...
export default function ProjectEdit(){
  ...
  const onFileChange = async (e) => {
    ...
    try {
      ...
      const res = await authService.client.post('https://localhost/api/v1/upload/', formData, {
  ...
  const onSubmit = async (e)=>{
    ...
    try{
      ...
      await authService.client.patch(`https://localhost/api/v1/projects/${id}/`, payload)
      setOk(true)
