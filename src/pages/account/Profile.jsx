    ...
    <section className="min-h-[calc(100vh-4rem)] bg-gradient-to-b from-white to-slate-50">
      <div className="section-frame py-8 space-y-6">
        <div className="relative overflow-hidden rounded-3xl bg-white/60 ring-1 ring-slate-200 p-6 sm:p-8">
          ...
          <p className="lead mt-2 max-w-2xl">Actualizá tu información básica. (Datos guardados en localStorage – modo demo)</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="card-surface p-6 max-w-2xl space-y-5">
          ...
          <div>
            ...
            <input id="avatar" name="avatar" className="input" placeholder="https://…" value={form.avatar} onChange={onChange} />
          </div>
